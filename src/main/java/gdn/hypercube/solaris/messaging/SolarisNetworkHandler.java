    ...
    public void onInitialize() {
        ...
        packets.forEach(clazz -> {
            try {
                ...
                CustomPayload.Id<? extends SolarisPacket> id = packet.ident();
                PacketCodec<RegistryByteBuf, ? extends SolarisPacket> codec = packet.codec();
                SolarisPacket.Direction direction = packet.direction();
                SolarisPacket.Handler<? extends SolarisPacket> handler = packet.handler();
                ...
                MiscHelpers.oopsie(LOGGER, "FAILED REGISTERING PACKET: " + clazz.getSimpleName(), exception);
